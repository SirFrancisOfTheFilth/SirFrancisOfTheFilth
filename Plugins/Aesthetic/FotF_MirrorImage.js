...
(function () {	
	...
	UnitRenderer.drawScrollUnit = function (unit, x, y, unitRenderParam) {
		FotF_DrawMirrorImageMoving(unit, x, y, unitRenderParam);	
	...
	MapLayer.drawUnitLayer = function () {
		...
		var allyList = AllyList.getAliveDefaultList();
			...
			for (i = 0; i < playerList.getCount(); i++) {
				...
				FotF_DrawMirrorImageStatic(unit);
			}
...
//static draw function for use in drawUnitLayer
var FotF_DrawMirrorImageStatic = function(unit) {
	...
	if (typeof PosChecker.getTerrainFromPosEx(unit.getMapX(), unit.getMapY() + 1) !== 'undefined' && PosChecker.getTerrainFromPosEx(unit.getMapX(), unit.getMapY() + 1) !== null) {
	...
	if (typeof PosChecker.getTerrainFromPosEx(unit.getMapX(), unit.getMapY() + 2) !== 'undefined' && PosChecker.getTerrainFromPosEx(unit.getMapX(), unit.getMapY() + 2) !== null) {
...
//moving draw function for use in drawScrollUnit
var FotF_DrawMirrorImageMoving = function(unit, x, y, unitRenderParam) {
