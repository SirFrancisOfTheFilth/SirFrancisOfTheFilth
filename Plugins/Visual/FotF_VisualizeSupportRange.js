...
var FotF_FirstTurnSupportClear = null;												//No touchy!
...
(function () {
	/*
	FotF_SupportRangeMapLayer = MapLayer.drawMapLayer;
	...
	*/
	var FotF_ResetRangeFirstTurn = PlayerTurn.openTurnCycle;
	PlayerTurn.openTurnCycle = function() {
		FotF_ResetRangeFirstTurn.call(this);
		if (FotF_FirstTurnSupportClear === null) {
			FotF_SupportRangeCache = null;
			root.log('FotF_SupportRangeCache reset');
		}
	};
	
	var FotF_SupportRangeMapLayer = CurrentMap.prepareMap;
	CurrentMap.prepareMap = function () {
		FotF_SupportRangeMapLayer.call(this);
		if (FotF_SupportRangeCache === null && root.getCurrentSession() !== null) {
			FotF_CreateMergeArray();
			root.log('merge array created');
		}
	};
